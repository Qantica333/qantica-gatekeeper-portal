...
{/* Third and fourth buttons centered in the second row */}
<div className="flex flex-col md:flex-row justify-center items-center gap-6">
  ...
  <div className="w-full md:w-1/2 max-w-md">
    <Button 
      onClick={() => handleDownload('Qantica Vision.pdf', 'Qantica Vision')}
      className="w-full h-24 bg-yellow-400 hover:bg-yellow-500 text-black border-2 border-yellow-400 transition-colors flex flex-col items-center justify-center p-4"
    >
      <div className="flex items-center gap-2 mb-1">
        <Download className="w-5 h-5" />
        <span className="font-semibold text-lg">Qantica’s Vision</span>
      </div>
      <span className="text-sm text-gray-800">The story behind our mission</span>
    </Button>
  </div>
</div>
      </div>
